-- скрипт для выполнения всех заданий для раздела нетологии Введение в БД
-- Таблицы исполнителей, их альбомов, сборников, наполнение и запросы 
-- перед запуском удалите старые таблицы
